...
internal class Repository<TEntity>(ApplicationDbContext context, ILogger<Repository<TEntity>> logger)
    : IRepository<TEntity>
    where TEntity : BaseEntity
{
    ...
    {
        logger.LogDebug("Getting paged {EntityType} entities with count - Page: {PageNumber}, Size: {PageSize}", 
    ...
    {
        logger.LogDebug("Getting paged {EntityType} entities - Page: {PageNumber}, Size: {PageSize}", 
            typeof(TEntity).Name, pageNumber, pageSize);
    ...
    public async Task<IReadOnlyList<TEntity>> FindAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogDebug("Finding {EntityType} entities with predicate", typeof(TEntity).Name);
    ...
    public async Task<TEntity?> FindFirstAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogDebug("Finding first {EntityType} entity with predicate", typeof(TEntity).Name);
    ...
    public async Task AddAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Adding {EntityType} with ID {Id}", typeof(TEntity).Name, entity.Id);
    ...
    public async Task AddRangeAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Adding {Count} {EntityType} entities", entityList.Count, typeof(TEntity).Name);
    ...
    public Task UpdateAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Updating {EntityType} with ID {Id}", typeof(TEntity).Name, entity.Id);
    ...
    public Task UpdateRangeAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default)
    {
        ...
        var entityList = entities.ToList();
        logger.LogDebug("Updating {Count} {EntityType} entities", entityList.Count, typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Soft deleting {EntityType} with ID {Id}", typeof(TEntity).Name, id);
    ...
    public Task DeleteAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Soft deleting {EntityType} with ID {Id}", typeof(TEntity).Name, entity.Id);
    ...
    {
        logger.LogDebug("Hard deleting {EntityType} with ID {Id}", typeof(TEntity).Name, id);
    ...
    public Task HardDeleteAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogDebug("Hard deleting {EntityType} with ID {Id}", typeof(TEntity).Name, entity.Id);
    ...
    {
        logger.LogDebug("Restoring {EntityType} with ID {Id}", typeof(TEntity).Name, id);
    ...
    public async Task<int> BulkDeleteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogDebug("Bulk deleting {EntityType} entities", typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Checking existence of {EntityType} with ID {Id}", typeof(TEntity).Name, id);
    ...
    public async Task<bool> ExistsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogDebug("Checking existence of {EntityType} with predicate", typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Getting count of {EntityType} entities", typeof(TEntity).Name);
    ...
    public async Task<int> GetCountAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogDebug("Getting count of {EntityType} entities with predicate", typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Getting deleted {EntityType} entities", typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Getting all {EntityType} entities including deleted", typeof(TEntity).Name);
    ...
    {
        logger.LogDebug("Getting {EntityType} with ID {Id} including deleted", typeof(TEntity).Name, id);
